  ...
  FMG.renderCreditsView = function () {
    return `
      <section class="panel">
        ...
        <p class="hero-copy">Football Manager Chile es un simulador local en vanilla JavaScript y Three.js. Guarda todo en tu navegador mediante localStorage y no envia datos a servidores.</p>
        <div class="content-grid" style="margin-top:18px;">
          ...
          <article class="card"><h2>Ejecucion local</h2><p class="muted">Usa Live Server, <code>python -m http.server 8080</code> o <code>npx serve .</code>.</p></article>
