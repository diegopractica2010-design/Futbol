  ...
  FMG.renderOnboardingView = function () {
    return `
      <section class="panel onboarding-view">
        ...
        <div class="content-grid" style="margin-top:18px;">
          <article class="log-item"><strong>Primera semana</strong><p class="muted">Revisa plantilla, ajusta formacion, mira al proximo rival y simula la fecha desde Inicio o Partidos.</p></article>
          <article class="log-item"><strong>Lectura de jugadores</strong><p class="muted">OVR mide rendimiento actual, POT el techo, energia el cansancio y moral la respuesta emocional del plantel.</p></article>
          <article class="log-item"><strong>Ciclo semanal</strong><p class="muted">Cada semana actualiza tabla, lesiones, sanciones, noticias, finanzas, mercado, objetivos y confianza del directorio.</p></article>
        </div>
