    ...
    <section class="hero">
      <div class="panel hero-main">
        ...
        <div class="stats-grid">
          <article class="stat-card"><div class="muted">Saldo disponible</div><div class="stat-value">${currency(state.finances.balance)}</div></article>
      ...
      <div class="side-stack">
        ...
        <section class="panel">
          ...
          <div class="log-list">
            ...
            <div class="log-item"><strong>Patrocinio</strong><p class="muted">${currency(state.userClub.sponsor)}</p></div>
          </div>
        </section>
      </div>
    </section>
