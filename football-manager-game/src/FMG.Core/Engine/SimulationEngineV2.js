(function () {
  ...
  /**
   * SimulationEngineV2 — Immutable, reducer-based simulation
   * Features:
   ...
   */
  function SimulationEngineV2(config) {
    config = config || {};
   ...
   */
  SimulationEngineV2.prototype.initialize = function (gameState) {
    if (!gameState) {
   ...
   */
  SimulationEngineV2.prototype._setupHooks = function () {
    const self = this;
   ...
   */
  SimulationEngineV2.prototype._logTransition = function (context) {
   ...
   */
  SimulationEngineV2.prototype.advanceWeek = function (gameState, command) {
    if (!gameState) {
      throw new Error("GameState required");
    }
   ...
   */
  SimulationEngineV2.prototype.getState = function () {
    if (!this.pipeline) {
      return null;
    }
   ...
   */
  SimulationEngineV2.prototype.loadSnapshot = function (snapshotId) {
   ...
   * Get execution log
   */
  SimulationEngineV2.prototype.getExecutionLog = function () {
   ...
   * Get snapshot store
   */
  SimulationEngineV2.prototype.getSnapshotStore = function () {
   ...
   */
  SimulationEngineV2.prototype._autoSelectLineup = function (club) {
   ...
   */
  SimulationEngineV2.prototype._applyMatchStats = function (club, result, isHome) {
   ...
   */
  SimulationEngineV2.prototype._getPoints = function (goalsFor, goalsAgainst) {
   ...
   */
  SimulationEngineV2.prototype._updateStandings = function (season, result) {
    if (!season.standings) {
      return season;
    }
  ...
  FMG.Core.Engine.SimulationEngineV2 = SimulationEngineV2;
})();
